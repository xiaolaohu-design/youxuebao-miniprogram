...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__DF23A58",
    appName: "优学宝知识付费全功能系统",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "172.29.128.1,192.168.0.101,192.168.137.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_JdV2mQ";
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "优学宝知识付费"
    }
  },
  {
  ...
  {
    path: "pages/course/audiocourse",
    style: {
      navigationBarTitleText: "音频课程"
    }
  },
  {
    path: "pages/course/imagecourse",
    style: {
      navigationBarTitleText: "图文课程"
    }
  },
  {
    path: "pages/course/specialcourse",
    style: {
      navigationBarTitleText: "专题课程"
    }
  },
  {
    path: "components/courseware",
    style: {
      navigationBarTitleText: "公共课件"
    }
  },
  {
    path: "pages/courseware/courseware",
    style: {
      navigationBarTitleText: "综合课件"
    }
  },
  {
    path: "pages/courseware/specialcourseware",
    style: {
      navigationBarTitleText: "专题课件"
    }
  },
  {
    path: "components/exampaper",
    style: {
      navigationBarTitleText: "公共试卷"
    }
  },
  {
    path: "pages/exampaper/exampaper",
    style: {
      navigationBarTitleText: "综合试卷"
    }
  },
  {
    path: "pages/exampaper/specialexampaper",
    style: {
      navigationBarTitleText: "精选试卷"
    }
  },
  {
    path: "pages/exampaper/groupexampaper",
    style: {
      navigationBarTitleText: "组卷试卷"
    }
  },
  {
    path: "pages/practice/practice",
    style: {
      navigationBarTitleText: "考试刷题"
    }
  },
  {
    path: "pages/practice/practicedetail",
    style: {
      navigationBarTitleText: "刷题练习"
    }
  },
  {
    path: "pages/practice/titledetail",
    style: {
  ...
  {
    path: "pages/exchange/exchangelist",
    style: {
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "资源",
      iconPath: "/static/tabbar/my_course_tabbar.png",
      selectedIconPath: "/static/tabbar/my_course_selected.png"
    },
    {
      pagePath: "pages/message/message",
      text: "消息",
      iconPath: "/static/tabbar/message_tabbar.png",
