...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const goToExampaper = (item) => {
      common_vendor.index.navigateTo({
        url: `/pages/exampaper/exampaper?id=${item.paper_id}`,
        fail: () => common_vendor.index.showToast({
          title: "跳转失败",
          icon: "none"
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-a9d559f0"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/exampaper/exampaper.js.map
